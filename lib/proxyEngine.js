...
module.exports = {
  ...
  addCrons: (app) => {
    ...
    Object.keys(app.crons).forEach(function(key) {
      ...
      if (
        ...
        && app.config.get('proxyEngine.crons_config.auto_schedule') !== false
      ){
        cron.schedule()
  ...
  addEvents: (app) => {
    ...
    Object.keys(app.events).forEach(function(key) {
      ...
      if (
        ...
        && app.config.get('proxyEngine.events_config.auto_subscribe') !== false
      ){
        event.subscribe()
  ...
  addHooks: (app) => {
    ...
    // app.config.get('main.packs').forEach(Pack => {
    //   console.log(Pack)
    //
    //   try {
    //     const hook = Pack._resolve
    //     console.log(hook)
    //   }
    //   catch (e) {
